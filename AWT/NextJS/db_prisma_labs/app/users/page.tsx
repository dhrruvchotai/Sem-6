...
import UserDeleteBtn from './../../components/DeleteUserBtn';
...
export default async function GetAllUsers() {
    ...
    return (
      <div className="relative bg-blue-500  max-w-xs w-full p-6 border mt-1.5 ml-6 border-black border-l-4 rounded-3xl rounded-base shadow-xs">
        ...
        <div className="flex flex-col items-center">
          <img
            className="w-24 h-24 mb-6 rounded-full text-6xl bg-gray-100 text-black text-center"
  ...
  return (
    <>
      <body>
        <div className="grid grid-cols-4 gap-4">{users_data}</div>
      </body>
    </>
  );
}
